...
This project is a 6 degree-of-freedom flight dynamics simulator of a rigid body aircraft. The goal is self stabilization once a wind gust is introduced. Below are project specifications: 
...
Assumptions: 
* Constant gravity 
* Flat Earth (over small surface area)
